...
*ConstrainedType.Inequality* builds inequality constraints and helper functions from a comparable. See [ConstrainedType_Inequality.resi](ConstrainedType_Inequality.resi) for documentation.
